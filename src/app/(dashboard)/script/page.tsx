...
export default function ScriptPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <p className="text-muted-foreground">输入选题，老E 自动判定类型→to who→叙事结构→管线执行。</p>
      ...
      {phase === "idle" && (
        <Card className="glass border-0 shadow-sm">
          <CardContent className="p-6 space-y-4">
            ...
            <Button onClick={() => runScript(topic, contentType)} disabled={!topic.trim()} className="w-full h-11 smooth">
